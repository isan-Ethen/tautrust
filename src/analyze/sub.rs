...
impl<'tcx> Analyzer<'tcx> {
    ...
    //             Ok(value) => env.assign_new_value(var, value.get_var_expr().to_string()),
    ...
    //                 env.assign_var_expr(var, constraint.clone());
    //             }
    //             _ => {
    //                 println!("{init:?}");
    //                 panic!(
    ...
    //         let temp = mut_init.get_var_expr().clone();
    //         mut_init.set_var_expr(name.clone());
